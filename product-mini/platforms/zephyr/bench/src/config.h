...
#define BENCHMARK_SOCKET (BENCHMARK_SOCKET_CREATE \
|| BENCHMARK_SOCKET_CONNECT \
|| BENCHMARK_SOCKET_BIND \
|| BENCHMARK_SOCKET_SENDTO \
|| BENCHMARK_SOCKET_RECVFROM)

#define BENCHMARK_FS (BENCHMARK_FS_FOPEN \
|| BENCHMARK_FS_FWRITE \
|| BENCHMARK_FS_FREAD \
|| BENCHMARK_FS_FSEEK \
|| BENCHMARK_FS_FCLOSE \
